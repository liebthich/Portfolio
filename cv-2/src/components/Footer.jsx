...
//                 <img className="w-auto h-9" src={logo1} alt="" />
...
//         <p className="text-sm text-center text-gray-600">© Copyright 2022, All Rights Reserved by Haces</p>
//     </div>
// </section>
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 lg:gap-x-24">
            ...
            <div className="text-center lg:text-left">
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Elevating brands through strategic design solutions.</h2>
                <p className="mt-6 text-base text-gray-600">Discover the Power of Strategic Design: Elevate Your Brand and Forge Connections That Drive Success.</p>

                <a href="#" title="" className="inline-flex items-center justify-center px-8 py-4 
				font-semibold text-white transition-all duration-200 bg-blue-600 rounded-md mt-9
				 hover:bg-blue-700 focus:bg-blue-700" role="button"> Check all 1486 apps </a>
            </div>
        </div>
    </div>
</section>
